...
Для коректного выполнения данной команды необходимо убедится, что сурвис postgresql работает и выполнить команду:
...
В ход выполнения ДЗ письмо не получилось отправить, так возникли проблемы с доступом к SMTP серверу.
